    ...
    jQuery('.menu-menu-header-container>li>a[href*="#"]').on("click", function() {
        ...
        */
        ...
        iframe: {
          ...
          $(".self_header ul li a").on("click",function(){
            var z = $(this).attr("data-value");
            if( z != 'home' && z != 'about' &&  
                z != 'services' && z != 'portfolio' && z != 'contact' && z != 'shop' )
                {
                    var c=$(this).attr('data-class');
                    $('.self_page_sections').hide();
                    $('.si_sect .si_active').addClass("si_deactive");
                    $('.si_sect .si_active').removeClass("si_active");
                    $('.'+z+'').addClass("si_active");
                    $('.si_sect .si_deactive').removeClass("prt_right prt_left prt_top prt_bottom");
                    $('.'+z+'').addClass(c);
                    $('.si_sect .'+z+'').removeClass("si_deactive");
                }
           else{
                     $('.self_page_sections').show();
                     $('.si_sect .si_active').addClass("si_deactive");
                     $('.si_sect .si_active').removeClass("si_active");
                     $('.si_sect .si_deactive').removeClass("prt_right prt_left prt_top prt_bottom"); 
            }
